...
# DFS search: stops when the target vertex is found.
def dfs_search(graph, vertex, target, visited=None):
    if visited is None:
        visited = set()
